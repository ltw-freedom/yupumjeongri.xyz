    ...
    [
      {
        ...
        a: `네, ${display}을 포함한 서울·경기 전 지역 방문 견적이 무료입니다. 상담 회신 때 주거 형태와 짐의 양을 여쭤보고 방문 전에 대략적인 범위도 안내드립니다.`,
      },
      {
...
export function cityFaqs(city: DistrictCity): { q: string; a: string }[] {
  ...
  return [
    ...
    {
      q: `방문 견적에 비용이 드나요?`,
      a: `무료입니다. 상담 회신 때 주거 형태와 짐의 양을 여쭤보고 방문 전에 예상 범위도 안내드립니다. 방문 후 항목별 견적서를 드리고, 견적서에 없는 금액은 청구하지 않습니다.`,
    },
  ];
}
