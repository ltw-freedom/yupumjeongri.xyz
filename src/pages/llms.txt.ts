...
export const GET: APIRoute = async () => {
  ...
  const lines = [
    ...
    `- 상담: 전화 상담은 운영하지 않습니다. ${absoluteUrl(site.consultPath)} 의 상담 폼 또는 카카오톡 1:1 채팅(${site.kakaoUrl})으로 접수하며, ${site.responsePromise}.`,
    ...
    `- [상담 신청](${absoluteUrl(site.consultPath)}): 상담 폼 접수 창구 (카카오톡 1:1 채팅도 가능)`,
    '',
    '## 칼럼',
    '',
